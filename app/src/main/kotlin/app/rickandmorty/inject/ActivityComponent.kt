...
interface ActivityComponent {
  @ForScope(AppScope::class) val viewModelFactory: ViewModelProvider.Factory
  ...
  interface Factory {
    fun createComponent(activity: ComponentActivity): ActivityComponent
  }

  companion object {
    fun create(activity: ComponentActivity): ActivityComponent =
      (activity.application as ActivityComponentFactoryOwner)
